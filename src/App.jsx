...
const App = () => {
    ...
    const inputs = [
      ...
      { id: 8, name: "lastname", type: "text", placeholder: "Enter last name", errorMessage: "Username should be 3-16 characters and shouldn't include any special character!", label: "Last Name", pattern: "^[A-Za-z ]{1,16}$", required: true },
    ...
    return (
      <div className="app">
        <form onSubmit={handleSubmit}>
          <h1>HSS Registeration Form</h1>
          <p>Choose your career wisely and complete this form!!!</p>
